...
<div class="w3-bar w3-white w3-large">
  <a href="#" class="w3-bar-item w3-button w3-red w3-mobile"><i class="fa fa-bed w3-margin-right"></i>Logo</a> <!-- Banner logo -->
...
<header class="w3-display-container w3-content" style="max-width:1500px;">
  ...
  <div class="w3-display-left w3-padding w3-col l6 m8">
    <div class="w3-container w3-red">
      <h2><i class="fa fa-bed w3-margin-right"></i>Le Fabuleux Motel</h2> <!-- MOTELL NAME -->
    </div>
...
<div class="w3-content" style="max-width:1532px;">
  ...
  <div class="w3-row-padding w3-padding-16">
    <div class="w3-third w3-margin-bottom">
      <img src="./public/images/single-room.jpg" alt="Norway" style="width:100%"> <!-- Single Room Picture -->
      <div class="w3-container w3-white">
        ...
        <button class="w3-button w3-block w3-black w3-margin-bottom">Choose Room</button> <!-- Order room button -->
      </div>
    </div>
    <div class="w3-third w3-margin-bottom">
      <img src="./public/images/double-room.jpg" alt="Norway" style="width:100%"> <!-- Double Room Picture -->
      <div class="w3-container w3-white">
        <h3>Double Room</h3>
    ...
    <div class="w3-third w3-margin-bottom">
      <img src="./public/images/deluxe-room.jpg" alt="Norway" style="width:100%"> <!-- Deluxe Room Picture -->
      <div class="w3-container w3-white">
        <h3>Deluxe Room</h3>
  ...
  <div class="w3-row-padding" id="about">
    ...
    <div class="w3-col l8 12">
      ...
      <img src="./public/images/about.jpg" class="w3-image w3-greyscale" style="width:100%;"> <!-- About Section (location) Picture -->
    </div>
  </div>
